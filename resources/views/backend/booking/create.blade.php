            ...
            <div class="card radius-10">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">Add Booking</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-body">
                        <form class="row g-4" method="post" action="{{ route('booking.store') }}">
                            @csrf
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 mb-3 ">
                                ...
                                <input type="text" class="form-control" id="consignee" placeholder="Consignee" name="consignee"
                                required>
                            </div>
                            <div class="col-md-4 mb-3 ">
                                <label for="consignor_gstin" class="form-label">Consignor GSTIN</label>
                                <input type="text" class="form-control" id="consignor_gstin" placeholder="Consignor GSTIN" name="consignor_gstin"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3 ">
                                <label for="consignee_gstin" class="form-label">Consignee GSTIN</label>
                                <input type="text" class="form-control" id="consignee_gstin" placeholder="Consignee GSTIN" name="consignee_gstin"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="booking_no" class="form-label">Booking No<span>*</span></label>
                                <input type="text" class="form-control" id="booking_no" name="booking_no" placeholder="Booking No"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="no_of_pack" class="form-label">No Of Package<span>*</span></label>
                                <input type="text" class="form-control" id="no_of_pack" name="no_of_pack" placeholder="No Of Package"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="product" class="form-label">Nature of Goods Said to contain<span>*</span></label>
                                <input type="text" class="form-control" id="product" name="product" placeholder="Nature of Goods Said to contain"
                                    required>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="freight_charges" name="freight_charges" placeholder="Freight Charges"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="insurance" class="form-label">Insurance<span>*</span></label>
                                <input type="text" class="form-control" id="insurance" name="insurance" placeholder="Insurance"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="b_charges" class="form-label">B Charges<span>*</span></label>
                                <input type="text" class="form-control" id="b_charges" name="b_charges" placeholder="B Charges"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="other_charges" class="form-label">Other Charges<span>*</span></label>
                                <input type="text" class="form-control" id="other_charges" name="other_charges" placeholder="Other Charges"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label for="tax" class="form-label">GST<span>*</span></label>
                                <input type="text" class="form-control" id="tax" name="tax" placeholder="GST"
                                    required>
                            </div>
                            <div class="col-md-4">
