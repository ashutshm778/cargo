            ...
            <div class="card radius-10">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">@if(auth()->guard("admin")->user()->can("consigner-create"))
                ...
                'columns': [
                    ...
                    },
                    {
                        mRender: function(data, type, row) {
                            ...
                            return '<div class="d-flex order-actions">@if(auth()->guard("admin")->user()->can("consigner-edit"))<a href="'+editUrl+'" class="me-2"><i class="bx bxs-edit"></i></a>@endif</div>'
                        }
                    },
