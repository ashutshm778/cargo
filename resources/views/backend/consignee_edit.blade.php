    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="card radius-10">
                ...
                <div class="card-body">
                    <div class="form-body">
                        <form class="row g-4" method="post" action="{{ route('admin.consignee_update') }}">
                            @csrf
                            <input type="hidden" name="id" value="{{$consignee->id}}" />
                            <div class="col-md-4">
                                <label for="fullname" class="form-label">Name<span>*</span></label>
                                <input type="text" class="form-control" id="fullname" name="name" placeholder="Name" value="{{$consignee->name}}"
                                    required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="Mobile No." value="{{$consignee->phone}}" required>
                            ...
                            <div class="col-md-4 mb-3 ">
                                ...
                                <select class="form-control" id="pincode_select" name="pincode"
                                    ...
                                    @if (!empty($consignee->pincode))
                                    <option value="{{ $consignee->pincode }}" selected>
                                        {{ $consignee->pincode }}</option>
                                @endif
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="address" class="form-label">Address<span>*</span></label>
                                <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="{{$consignee->full_address}}"
                                    required>
                            </div>
                            <div class="col-12">
                                <div class="">
