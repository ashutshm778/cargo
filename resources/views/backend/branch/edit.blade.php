    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="card radius-10">
                ...
                <div class="card-body">
                    <div class="form-body">
                        <form class="row g-4" method="post" action="{{ route('branch.update',$branch->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="col-md-4">
                                <label for="fullname" class="form-label">Name<span>*</span></label>
                                <input type="text" class="form-control" id="fullname" name="name" placeholder="Name" value="{{$branch->name}}"
                                    required>
                                    <strong>{{ $errors->first('name') }}</strong>
                            </div>
                            <div class="col-md-4">
                                <label for="branch_code" class="form-label">Branch Code<span>*</span></label>
                                <input type="text" class="form-control" id="branch_code" name="branch_code" placeholder="Branch Code" value="{{$branch->branch_code}}"
                                    required>
                                    <strong>{{ $errors->first('branch_code') }}</strong>
                            </div>
                            <div class="col-md-4">
                                <label for="email" class="form-label">Email<span>*</span></label>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{$branch->email}}"
                                    required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="Mobile No." value="{{$branch->phone}}" required>
                                <span style="display: block; width: 100%;margin-top: 0.25rem;font-size: 80%;color: #dc3545;"
                                    role="alert">
                            ...
                            <div class="col-md-4">
                                <label for="gst" class="form-label">GSTIN<span>*</span></label>
                                <input type="text" class="form-control" id="gst" name="gst" placeholder="GSTIN" value="{{$branch->gst}}"
                                    required>
                                <span style="display: block; width: 100%;margin-top: 0.25rem;font-size: 80%;color: #dc3545;"
                                    role="alert">
                            ...
                            <div class="col-md-4 mb-3 ">
                                ...
                                <select class="form-control" id="pincode_select" name="pincode"
                                    ...
                                    @if (!empty($branch->pincode))
                                    <option value="{{ $branch->pincode }}" selected>
                                        {{ $branch->pincode }}</option>
                                    @endif
                                </select>
                            </div>
                            <div class="col-md-4 mb-3 ">
                                <label for="city" class="form-label">City</label>
                                <input type="text" class="form-control" id="city" placeholder="City" name="city" value="{{$branch->city}}"
                                    readonly>
                            </div>
                            <div class="col-md-4 mb-3 ">
                                <label for="state" class="form-label">State</label>
                                <input type="text" class="form-control" id="state" placeholder="State" name="state" value="{{$branch->state}}"
                                    readonly>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 mb-3 ">
                                ...
                                <select class="form-control" id="serving_pincode_select" name="serving_pincode[]"
                                    ...
                                    <option value="">Select Pincode</option>
                                    @if (!empty(json_decode($branch->serving_pincode)))
                                    @foreach(json_decode($branch->serving_pincode) as $serving_pincode)
                                    <option value="{{ $serving_pincode }}" selected>
                                        {{ $serving_pincode }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
