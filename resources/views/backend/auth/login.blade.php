									...
									<div class="form-body">
										<form class="row g-3" method="post" action="{{route('admin.login')}}">
											...
											<div class="col-12">
												...
												<input type="email" name="email" class="form-control" id="inputEmailAddress" placeholder="Enter Your Email" value="{{old('email')}}">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" name="password" class="form-control border-end-0" id="inputChoosePassword" value="{{old('password')}}" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
                                                    <span style="display: block; width: 100%;margin-top: 0.25rem;font-size: 80%;color: #dc3545;" role="alert">
