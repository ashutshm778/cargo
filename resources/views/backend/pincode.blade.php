                            ...
                            <table id="example" class="table table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>State</th>
                                        <th>Status</th>
                                        @if(auth()->guard('admin')->user()->canany(['pincode-edit','product-delete']))    <th>Action</th> @endif
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($pincodes as $pincode)
                                        <tr>
                                            ...
                                            @if(auth()->guard('admin')->user()->canany(['pincode-edit','product-delete']))     <td>
                                                <div class="d-flex order-actions">
                                                    ...
                                                    <a href="{{route('admin_pincode.delete', $pincode->id)}}" class="ms-3"><i class="bx bxs-trash"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                            @endif
