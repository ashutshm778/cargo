    ...
    <div class="modal fade" id="consigner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-body">
                    <form class="row" method="post" action="#">
                        ...
                        <div class="col-md-4 mb-3 ">
                            ...
                            <select class="form-control" id="pincode_select2" wire:model="pincode" required>
                        ...
                        <div class="col-12">
                            <div class="text-end">
                                <button type="button" class="btn btn-primary" wire:click="consigner_store()">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
