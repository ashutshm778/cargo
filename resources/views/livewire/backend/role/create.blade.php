            ...
            <div class="card radius-10">
                <div class="card-header">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group floating-label mb-2 mt-1">
                                    ...
                                    <input type="text" class="form-control" placeholder="Role Name" wire:model.defer="name">
                                    @error('name')
                                        ...
                                        <div class="card-body" style="height: 200px; overflow-x: hidden;">
                                            ...
                                            @foreach ($permissions as $value)
                                                <div class="icheck-danger">
                                                    <input type="checkbox" wire:model="permission.{{$value->id}}" id="roles_{{$value->name}}" value="{{$value->id}}">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btns btn-primary CardBtn" wire:click="store()">Save</button>
                    </div>
