...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="thumb">
                                <img class="w-100" src="{{ asset('frontend/assets/img/about/5.png')}}" alt="img">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="thumb img-2">
                                <img class="w-100" src="{{ asset('frontend/assets/img/about/6.png')}}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="video-area pd-top-120 pd-bottom-120" style="background: #080C24;">
        <div class="video-thumb-wrap">
            <img src="{{ asset('frontend/assets/img/video/1.png')}}" alt="img">
            <a class="video-play-btn" href="https://www.youtube.com/embed/Wimkqo8gDZ0" data-effect="mfp-zoom-in"><i class="fa fa-play"></i></a>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="cta-inner-wrap" style="background: url({{ asset('frontend/assets/img/video/bg.png')}});">
